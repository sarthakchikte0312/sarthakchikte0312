...
- 🔭 I’m currently working on **16 Array Line Follower Bot using ESP32**
...
- ⚡ Fun fact **Stuck in an endless loop of learn → build → break → Google → repeat.**
...
<!--
**sarthakchikte0312/sarthakchikte0312** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
